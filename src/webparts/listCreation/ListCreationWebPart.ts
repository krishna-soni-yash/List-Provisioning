...
import { IListCreationProps } from './components/IListCreationProps';
import { createPnpSpfx, provisionRequiredLists } from '../../schema/RequiredList';
...
export default class ListCreationWebPart extends BaseClientSideWebPart<IListCreationWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IListCreationProps> = React.createElement(
      ListCreation,
      {
  ...
  protected async onInit(): Promise<void> {
    const sp = createPnpSpfx(this.context);
